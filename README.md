...
Alteryx Move Item Macro utilise [PowerShell's Move-Item function](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.management/move-item).
